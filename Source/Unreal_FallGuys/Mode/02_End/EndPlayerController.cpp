...
void AEndPlayerController::SetupInputComponent()
{
	Super::SetupInputComponent();
	SetupInputComponentEvent();
}

void AEndPlayerController::AddMappingContext(UInputMappingContext* _MappingContext)
{
...
const UInputAction* AEndPlayerController::GetInputAction(FStringView _Name)
{
